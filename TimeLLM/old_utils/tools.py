        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(vali_loader)):
            ...
            if args.llm_model == "Moirai":
                if args.output_attention:
                    outputs = model(batch_x, batch_x_mark, dec_inp, batch_y_mark, data_w_cov=batch_x, future_cov=batch_y, use_cov=True)[0]
                else:
                    outputs = model(batch_x, batch_x_mark, dec_inp, batch_y_mark, data_w_cov=batch_x, future_cov=batch_y, use_cov=True)
            else:
                if args.use_amp:
