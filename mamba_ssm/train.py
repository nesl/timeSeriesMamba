...
from mamba_ssm.data_provider.data_factory import data_provider
import time
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    if args.llm_model == "Moirai":
        model = BackboneModel.Uni2TSWrapper(args).float()
    else: 
    ...
    if args.llm_model == "Moirai": #this is a foundation model with just eval and no training!
        model.eval()
