...
class MambaTimeHeadModel(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        self.time_head = nn.Linear(d_model, vocab_size, bias=False, **factory_kwargs)
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, num_last_tokens=0, **mixer_kwargs):
        ...
        CausalTimeOutput = namedtuple("CausalTimeOutput", ["logits"])
        return CausalTimeOutput(logits=time_logits)
